...
class WorkstationStackTests(unittest.TestCase):
    ...
    def _make_stack(
        ...
        **kwargs,
        ...
        environment_spec = kwargs.pop("environment_spec", TEST_SPEC)
    ...
    def test_ssh_mode_uses_plain_ip_as_single_host_ingress(self) -> None:
        """Expected: a plain IP is normalized to /32 for SSH ingress."""
        app = core.App()
        stack = self._make_stack(
            app,
            "aws-workstation-ssh-restricted-host",
            access_mode="ssh",
    ...
    def test_both_mode_uses_configured_ssh_cidr_verbatim(self) -> None:
        """Edge: a configured CIDR is preserved for SSH ingress in dual access mode."""
        app = core.App()
        stack = self._make_stack(
            app,
            "aws-workstation-both-restricted-cidr",
            access_mode="both",
            environment_spec=EnvironmentSpec(
                environment_key="test",
                display_name="Test",
