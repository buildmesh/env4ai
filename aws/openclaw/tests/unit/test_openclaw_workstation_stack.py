...
from openclaw_workstation.openclaw_workstation_stack import (
    OpenclawWorkstationStack,
    resolve_subnet_availability_zone,
)


class OpenclawWorkstationStackTests(unittest.TestCase):
    @staticmethod
    ...
    def test_subnet_az_uses_dynamic_get_azs_select_by_default(self) -> None:
        ...
        app = core.App()
        stack = OpenclawWorkstationStack(
